...
public enum AbilityCategory {
    ...
    BULLDOZER( "Бульдозер", "Контроль территории и инициация.", ColoursManager.yellow ), //
    ...
    MANIPULATOR( "Манипулятор", "Усиление боевых способностей#союзников и издевательства#над противниками.", ColoursManager.light_blue ), //buffing and debuffing
    MADMAN( "Безумец", "Агрессивные сильные эффекты#с риском для игрока.", ColoursManager.light_blue ), //sacrificial abilities
    ...
    BUILDER( "Архитектор", "Возведение тактических построек#из блоков и гаджетов.", ColoursManager.light_blue ), //gadgets and blocks
    ...
    public String getFullName() {
        return ColoursManager.gray + "[ " + this.color + this.name + ColoursManager.gray + " ]";
    }

    public ArrayList<String> generateFullDescription() {
        ArrayList<String> lore = new ArrayList<>();
        lore.add("");
        lore.add(ColoursManager.gray + "Вам автоматически установятся");
        lore.add(ColoursManager.gray + "способности из категории: " + this.getFullName());
        lore.add("");
        lore.addAll(NotificationManager.divideAndParseLines(this.getDescription(),"#"));
        lore.add("");
        return lore;
    }
}
