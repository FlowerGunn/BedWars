...
public class Stray extends SpecialItem implements org.screamingsandals.bedwars.api.special.Golem {
    ...
    public Stray(Game game, Player player, Team team,
    ...
    private void spawnMob() {
        ...
        final org.bukkit.entity.Stray golem = (org.bukkit.entity.Stray) location.getWorld().spawnEntity(location, EntityType.STRAY);
