...
public class Shulker extends SpecialItem implements org.screamingsandals.bedwars.api.special.Golem {
    ...
    public Shulker(Game game, Player player, Team team,
    ...
    private void spawnMob() {
        ...
        final org.bukkit.entity.Shulker golem = (org.bukkit.entity.Shulker) location.getWorld().spawnEntity(location, EntityType.SHULKER);
