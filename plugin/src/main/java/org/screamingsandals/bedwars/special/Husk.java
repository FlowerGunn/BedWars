...
public class Husk extends SpecialItem implements org.screamingsandals.bedwars.api.special.Golem {
    ...
    public Husk(Game game, Player player, Team team,
    ...
    private void spawnMob() {
        ...
        final org.bukkit.entity.Husk golem = (org.bukkit.entity.Husk) location.getWorld().spawnEntity(location, EntityType.HUSK);
