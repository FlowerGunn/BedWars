...
public class Guardian extends SpecialItem implements org.screamingsandals.bedwars.api.special.Golem {
    ...
    public Guardian(Game game, Player player, Team team,
    ...
    private void spawnMob() {
        ...
        final org.bukkit.entity.Guardian golem = (org.bukkit.entity.Guardian) location.getWorld().spawnEntity(location, EntityType.GUARDIAN);
