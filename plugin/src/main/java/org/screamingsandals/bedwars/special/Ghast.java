...
public class Ghast extends SpecialItem implements org.screamingsandals.bedwars.api.special.Golem {
    ...
    public Ghast(Game game, Player player, Team team,
    ...
    private void spawnMob() {
        ...
        final org.bukkit.entity.Ghast golem = (org.bukkit.entity.Ghast) location.getWorld().spawnEntity(location, EntityType.GHAST);
